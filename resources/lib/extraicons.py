...
LCD_EXTRAICONS = enum(
  ...
  'LCD_EXTRAICON_MAX',
  'LCD_EXTRAICON_FWD',         # for Futaba TOSD-5711BB
  'LCD_EXTRAICON_REW',         # for Futaba TOSD-5711BB
  'LCD_EXTRAICON_WEBRADIO',    # for Futaba TOSD-5711BB
  'LCD_EXTRAICON_TRAYOPEN'     # for Futaba TOSD-5711BB
)
